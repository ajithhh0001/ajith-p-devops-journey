...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Mail, href: "mailto:ajithhh000@gmail.com", label: "Email" },
    { icon: Linkedin, href: "https://linkedin.com/in/ajith--p", label: "LinkedIn" },
    { icon: Github, href: "https://github.com/ajithhh000", label: "GitHub" },
    { icon: Phone, href: "tel:+919562459210", label: "Phone" }
  ];
        ...
        <div className="py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center text-sm text-muted-foreground">
              <span>© 2025 Ajith P. Built with</span>
